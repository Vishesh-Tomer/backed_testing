...
router.post('/register', validate(authValidation.register), csrfProtection, adminAuthController.register);
router.post('/login', loginLimiter, validate(authValidation.login), csrfProtection, adminAuthController.login);
